...
declare class AffiliateEntity extends LearnworldsEntityBase<Affiliate> {
    ...
    list(this: any, reqmatch?: AffiliateListMatch, ctrl?: Control): Promise<AffiliateEntity[]>;
    create(this: any, reqdata?: AffiliateCreateData, ctrl?: Control): Promise<AffiliateEntity>;
}

...
(0, node_test_1.describe)('SubscriptionPlanEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(subscription_plan_ref01_data_dt0.id === subscription_plan_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/subscription_plan/SubscriptionPlanTestData.json');
    ...
    let idmap = transform(['subscription_plan01', 'subscription_plan02', 'subscription_plan03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',

...
(0, node_test_1.describe)('SubscriptionPlanDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-subscription_plan', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-subscription_plan', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-subscription_plan', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-subscription_plan', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_SUBSCRIPTION_PLAN_ENTID'];
...
//# sourceMappingURL=SubscriptionPlanDirect.test.js.map
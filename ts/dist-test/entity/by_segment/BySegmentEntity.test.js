...
(0, node_test_1.describe)('BySegmentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'by_segment.' + op, live))
                return;
        }
        ...
        let by_segment_ref01_data = Object.values(setup.data.existing.by_segment)[0];
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/by_segment/BySegmentTestData.json');
    ...
    let idmap = transform(['by_segment01', 'by_segment02', 'by_segment03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=BySegmentEntity.test.js.map
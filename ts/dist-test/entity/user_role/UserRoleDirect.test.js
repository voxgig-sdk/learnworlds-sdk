...
(0, node_test_1.describe)('UserRoleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-user_role', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-user_role', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_USER_ROLE_ENTID'];
...
//# sourceMappingURL=UserRoleDirect.test.js.map
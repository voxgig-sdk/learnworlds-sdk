...
(0, node_test_1.describe)('EventLogDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-event_log', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-event_log', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_EVENT_LOG_ENTID'];
...
//# sourceMappingURL=EventLogDirect.test.js.map
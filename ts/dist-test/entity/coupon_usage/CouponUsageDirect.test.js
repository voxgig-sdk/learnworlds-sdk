...
(0, node_test_1.describe)('CouponUsageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-coupon_usage', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-coupon_usage', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["coupon_usage01", "promotion01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            params.id = setup.idmap['coupon_usage01'];
            params.promotion_id = setup.idmap['promotion01'];
        }
        else {
            params.id = 'direct01';
            params.promotion_id = 'direct02';
        }
        const result = await client.direct({
            path: 'v2/promotions/{promotion_id}/coupons/{id}/usage',
            method: 'GET',
            params,
            query,
        });
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_COUPON_USAGE_ENTID'];
...
//# sourceMappingURL=CouponUsageDirect.test.js.map
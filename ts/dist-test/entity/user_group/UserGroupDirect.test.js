...
(0, node_test_1.describe)('UserGroupDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.LearnworldsSDK({
    ...
    (0, node_test_1.test)('direct-load-user_group', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-user_group', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-user_group', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-user_group', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["user_group01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            params.id = setup.idmap['user_group01'];
        }
        else {
            params.id = 'direct01';
        }
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.LearnworldsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['LEARNWORLDS_TEST_USER_GROUP_ENTID'];
    ...
    const client = new __1.LearnworldsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=UserGroupDirect.test.js.map
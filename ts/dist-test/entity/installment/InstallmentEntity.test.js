...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/installment/InstallmentTestData.json');
    ...
    let idmap = transform(['installment01', 'installment02', 'installment03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',

...
(0, node_test_1.describe)('InstallmentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-installment', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-installment', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_INSTALLMENT_ENTID'];
...
//# sourceMappingURL=InstallmentDirect.test.js.map
...
(0, node_test_1.describe)('MultipleSeatEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != multiple_seat_ref01_data.id);
        // LIST
        const multiple_seat_ref01_match = {};
        const multiple_seat_ref01_list = (await multiple_seat_ref01_ent.list(multiple_seat_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(multiple_seat_ref01_list, { id: multiple_seat_ref01_data.id })));
        // REMOVE
        const multiple_seat_ref01_match_rm0 = { id: multiple_seat_ref01_data.id };
        await multiple_seat_ref01_ent.remove(multiple_seat_ref01_match_rm0);
        // LIST
        const multiple_seat_ref01_match_rt0 = {};
        const multiple_seat_ref01_list_rt0 = (await multiple_seat_ref01_ent.list(multiple_seat_ref01_match_rt0)).map((e) => e.data());
        (0, node_assert_1.default)(isempty(select(multiple_seat_ref01_list_rt0, { id: multiple_seat_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/multiple_seat/MultipleSeatTestData.json');
    ...
    let idmap = transform(['multiple_seat01', 'multiple_seat02', 'multiple_seat03', 'seat01', 'seat02', 'seat03', 'user01', 'user02', 'user03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=MultipleSeatEntity.test.js.map
...
(0, node_test_1.describe)('MultipleSeatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-multiple_seat', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-multiple_seat', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'LEARNWORLDS_TEST_MULTIPLE_SEAT_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_MULTIPLE_SEAT_ENTID'];
...
//# sourceMappingURL=MultipleSeatDirect.test.js.map
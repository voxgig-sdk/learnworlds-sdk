...
(0, node_test_1.describe)('AssessmentEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/assessment/AssessmentTestData.json');
    ...
    let idmap = transform(['assessment01', 'assessment02', 'assessment03', 'form01', 'form02', 'form03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AssessmentEntity.test.js.map
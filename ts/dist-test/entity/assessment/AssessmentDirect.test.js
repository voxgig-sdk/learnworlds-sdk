...
(0, node_test_1.describe)('AssessmentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-assessment', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-assessment', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["form01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            params.form_id = setup.idmap['form01'];
        }
        else {
            params.form_id = 'direct01';
        }
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'LEARNWORLDS_TEST_ASSESSMENT_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_ASSESSMENT_ENTID'];
...
//# sourceMappingURL=AssessmentDirect.test.js.map
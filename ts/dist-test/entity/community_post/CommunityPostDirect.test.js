...
(0, node_test_1.describe)('CommunityPostDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-community_post', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-community_post', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_COMMUNITY_POST_ENTID'];
...
//# sourceMappingURL=CommunityPostDirect.test.js.map
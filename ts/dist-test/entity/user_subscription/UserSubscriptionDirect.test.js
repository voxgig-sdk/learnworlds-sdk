...
(0, node_test_1.describe)('UserSubscriptionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-user_subscription', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-user_subscription', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_USER_SUBSCRIPTION_ENTID'];
...
//# sourceMappingURL=UserSubscriptionDirect.test.js.map
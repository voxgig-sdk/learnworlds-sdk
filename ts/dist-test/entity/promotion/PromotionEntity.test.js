...
(0, node_test_1.describe)('PromotionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != promotion_ref01_data.id);
        // LIST
        const promotion_ref01_match = {};
        const promotion_ref01_list = (await promotion_ref01_ent.list(promotion_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(promotion_ref01_list, { id: promotion_ref01_data.id })));
        // LOAD
        ...
        (0, node_assert_1.default)(promotion_ref01_data_dt0.id === promotion_ref01_data.id);
    });
});

...
(0, node_test_1.describe)('SeatEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'update', 'load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'seat.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != seat_ref01_data.id);
        // UPDATE
        const seat_ref01_data_up0 = {};
        seat_ref01_data_up0.id = seat_ref01_data.id;
        const seat_ref01_markdef_up0 = { name: 'access', value: 'Mark01-seat_ref01_' + setup.now };
        seat_ref01_data_up0[seat_ref01_markdef_up0.name] = seat_ref01_markdef_up0.value;
        const seat_ref01_resdata_up0 = (await seat_ref01_ent.update(seat_ref01_data_up0)).data();
        (0, node_assert_1.default)(seat_ref01_resdata_up0.id === seat_ref01_data_up0.id);
        (0, node_assert_1.default)(seat_ref01_resdata_up0[seat_ref01_markdef_up0.name] === seat_ref01_markdef_up0.value);
        // LOAD
        const seat_ref01_match_dt0 = {};
        seat_ref01_match_dt0.id = seat_ref01_data.id;
        const seat_ref01_data_dt0 = (await seat_ref01_ent.load(seat_ref01_match_dt0)).data();
        (0, node_assert_1.default)(seat_ref01_data_dt0.id === seat_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/seat/SeatTestData.json');
    ...
    let idmap = transform(['seat01', 'seat02', 'seat03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',

...
(0, node_test_1.describe)('ReportingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-reporting', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-reporting', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'LEARNWORLDS_TEST_REPORTING_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_REPORTING_ENTID'];
...
//# sourceMappingURL=ReportingDirect.test.js.map
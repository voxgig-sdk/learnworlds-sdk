...
(0, node_test_1.describe)('ReportingEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/reporting/ReportingTestData.json');
    ...
    let idmap = transform(['reporting01', 'reporting02', 'reporting03', 'user01', 'user02', 'user03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ReportingEntity.test.js.map
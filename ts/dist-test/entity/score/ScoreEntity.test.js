...
(0, node_test_1.describe)('ScoreEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "score", "op": {}, "relations": { "ancestors": [] }, "key$": "score", "name__orig": "score", "Name": "Score", "name_": "score", "name-": "score", "NAME": "SCORE", "index$": 28 }, { "active": true, "entity": "score", "key$": "BasicScoreFlow", "kind": "basic", "name": "BasicScoreFlow", "param": {}, "step": [] }, 'Score');
        }

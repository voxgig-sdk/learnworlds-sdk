...
(0, node_test_1.describe)('CommunityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-community', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-community', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'LEARNWORLDS_TEST_COMMUNITY_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_COMMUNITY_ENTID'];
...
//# sourceMappingURL=CommunityDirect.test.js.map
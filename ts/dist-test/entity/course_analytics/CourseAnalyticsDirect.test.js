...
(0, node_test_1.describe)('CourseAnalyticsDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-course_analytics', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-course_analytics', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'LEARNWORLDS_TEST_COURSE_ANALYTICS_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_COURSE_ANALYTICS_ENTID'];
...
//# sourceMappingURL=CourseAnalyticsDirect.test.js.map
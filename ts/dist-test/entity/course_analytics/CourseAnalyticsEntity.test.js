...
(0, node_test_1.describe)('CourseAnalyticsEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'course_analytics.' + op, live))
                return;
        }
        ...
        let course_analytics_ref01_data = Object.values(setup.data.existing.course_analytics)[0];
        // LOAD
        const course_analytics_ref01_ent = client.CourseAnalytics();
        const course_analytics_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(course_analytics_ref01_data_dt0.id === course_analytics_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/course_analytics/CourseAnalyticsTestData.json');
    ...
    let idmap = transform(['course_analytics01', 'course_analytics02', 'course_analytics03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CourseAnalyticsEntity.test.js.map
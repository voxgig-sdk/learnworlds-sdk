...
(0, node_test_1.describe)('UnitAnalyticsDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-unit_analytics', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-unit_analytics', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["course_id01", "id01"]))
            return;
        ...
        if (setup.live) {
            ...
            params.course_id = 'direct01';
            params.id = 'direct02';
        }
        const result = await client.direct({
            path: 'v2/courses/{course_id}/units/{id}/analytics',
            method: 'GET',
            params,
            query,
        });
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'LEARNWORLDS_TEST_UNIT_ANALYTICS_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_UNIT_ANALYTICS_ENTID'];
...
//# sourceMappingURL=UnitAnalyticsDirect.test.js.map
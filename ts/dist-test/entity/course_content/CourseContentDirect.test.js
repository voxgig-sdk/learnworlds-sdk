...
(0, node_test_1.describe)('CourseContentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-course_content', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-course_content', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["course_content01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            params.id = setup.idmap['course_content01'];
        }
        else {
            params.id = 'direct01';
        }
        const result = await client.direct({
            path: 'v2/courses/{id}/contents',
            method: 'GET',
            params,
            query,
        });
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LEARNWORLDS_TEST_COURSE_CONTENT_ENTID'];
...
//# sourceMappingURL=CourseContentDirect.test.js.map
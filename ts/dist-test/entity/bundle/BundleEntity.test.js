...
(0, node_test_1.describe)('BundleEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(bundle_ref01_data_dt0.id === bundle_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/bundle/BundleTestData.json');
    ...
    let idmap = transform(['bundle01', 'bundle02', 'bundle03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',

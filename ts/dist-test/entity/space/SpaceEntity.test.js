...
(0, node_test_1.describe)('SpaceEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "space", "op": {}, "relations": { "ancestors": [] }, "key$": "space", "name__orig": "space", "Name": "Space", "name_": "space", "name-": "space", "NAME": "SPACE", "index$": 31 }, { "active": true, "entity": "space", "key$": "BasicSpaceFlow", "kind": "basic", "name": "BasicSpaceFlow", "param": {}, "step": [] }, 'Space');
        }

...
const TEST_SEED = { "entity": { "active": { "test01": { "id": "test01" } }, "affiliate": { "test01": { "id": "test01" } }, "assessment": { "test01": { "id": "test01" } }, "bundle": { "test01": { "id": "test01" } }, "by_product": { "test01": { "id": "test01" } }, "by_segment": { "test01": { "id": "test01" } }, "calendar": { "test01": { "id": "test01" } }, "certificate": { "test01": { "id": "test01" } }, "community": { "test01": { "id": "test01" } }, "community_post": { "test01": { "id": "test01" } }, "community_space": { "test01": { "id": "test01" } }, "completed": { "test01": { "id": "test01" } }, "coupon": { "test01": { "id": "test01" } }, "coupon_usage": { "test01": { "id": "test01" } }, "course": { "test01": { "id": "test01" } }, "course_analytics": { "test01": { "id": "test01" } }, "course_content": { "test01": { "id": "test01" } }, "due": { "test01": { "id": "test01" } }, "event": { "test01": { "id": "test01" } }, "event_log": { "test01": { "id": "test01" } }, "form": { "test01": { "id": "test01" } }, "installment": { "test01": { "id": "test01" } }, "lead": { "test01": { "id": "test01" } }, "multiple_seat": { "test01": { "id": "test01" } }, "payment": { "test01": { "id": "test01" } }, "post": { "test01": { "id": "test01" } }, "promotion": { "test01": { "id": "test01" } }, "reporting": { "test01": { "id": "test01" } }, "score": { "test01": { "id": "test01" } }, "seat": { "test01": { "id": "test01" } }, "segment": { "test01": { "id": "test01" } }, "space": { "test01": { "id": "test01" } }, "subscription_plan": { "test01": { "id": "test01" } }, "unit": { "test01": { "id": "test01" } }, "unit_analytics": { "test01": { "id": "test01" } }, "upcoming": { "test01": { "id": "test01" } }, "update_user_progress": { "test01": { "id": "test01" } }, "user": { "test01": { "id": "test01" } }, "user_group": { "test01": { "id": "test01" } }, "user_progress": { "test01": { "id": "test01" } }, "user_role": { "test01": { "id": "test01" } }, "user_subscription": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+LearnworldsSDK\b/.test(code) ||
        /\bLearnworldsSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+LearnworldsSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/LearnworldsSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);

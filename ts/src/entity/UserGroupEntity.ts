...
class UserGroupEntity extends LearnworldsEntityBase<UserGroup> {

  constructor(client: LearnworldsSDK, entopts: any) {
    super(client, entopts)
    this.name = 'user_group'
    this.name_ = 'user_group'
    this.Name = 'UserGroup'
  }


  make(this: UserGroupEntity) {
    return new UserGroupEntity(this._client, this.entopts())
  }
  ...
  async load(this: any, reqmatch?: UserGroupLoadMatch, ctrl?: Control): Promise<UserGroupEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<UserGroup> return stays clean under strict null checks.

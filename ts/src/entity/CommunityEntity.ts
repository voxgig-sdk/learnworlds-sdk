...
import type {
  ...
  CommunityListMatch,
  CommunityCreateData,
  CommunityRemoveMatch,
} from '../LearnworldsTypes'

// TODO: needs Entity superclass
class CommunityEntity extends LearnworldsEntityBase<Community> {
  ...
  make(this: CommunityEntity) {
    return new CommunityEntity(this._client, this.entopts())
  }




  async list(this: any, reqmatch?: CommunityListMatch, ctrl?: Control): Promise<CommunityEntity[]> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Community[]> return stays clean under strict null checks.
  ...
  async create(this: any, reqdata?: CommunityCreateData, ctrl?: Control): Promise<CommunityEntity> {
  ...
  async remove(
    this: any, reqmatch?: CommunityRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<CommunityEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }

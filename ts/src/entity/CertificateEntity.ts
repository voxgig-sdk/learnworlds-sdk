...
import type {
  ...
  CertificateRemoveMatch,
} from '../LearnworldsTypes'

// TODO: needs Entity superclass
class CertificateEntity extends LearnworldsEntityBase<Certificate> {

  constructor(client: LearnworldsSDK, entopts: any) {
    super(client, entopts)
    this.name = 'certificate'
    this.name_ = 'certificate'
    this.Name = 'Certificate'
  }


  make(this: CertificateEntity) {
    return new CertificateEntity(this._client, this.entopts())
  }




  async list(this: any, reqmatch?: CertificateListMatch, ctrl?: Control): Promise<CertificateEntity[]> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Certificate[]> return stays clean under strict null checks.
  ...
  async update(this: any, reqdata?: CertificateUpdateData, ctrl?: Control): Promise<CertificateEntity> {
  ...
  async remove(
    this: any, reqmatch?: CertificateRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<CertificateEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }

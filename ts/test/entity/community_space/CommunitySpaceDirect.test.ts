...
describe('CommunitySpaceDirect', async () => {
  ...
  test('direct-load-community_space', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-community_space', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['LEARNWORLDS_TEST_COMMUNITY_SPACE_ENTID']

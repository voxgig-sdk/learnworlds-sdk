...
describe('UserSubscriptionDirect', async () => {
  ...
  test('direct-list-user_subscription', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-user_subscription', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['LEARNWORLDS_TEST_USER_SUBSCRIPTION_ENTID']

...
| --- | --- | --- |
| `seneca_provider` | `seneca_provider/` | [`seneca_provider/AGENTS.md`](./seneca_provider/AGENTS.md) |
...
**Entities** (42): `Active`, `Affiliate`, `Assessment`, `Bundle`, `ByProduct`, `BySegment`, `Calendar`, `Certificate`, `Community`, `CommunityPost`, `CommunitySpace`, `Completed`, `Coupon`, `CouponUsage`, `Course`, `CourseAnalytics`, `CourseContent`, `Due`, `Event`, `EventLog`, `Form`, `Installment`, `Lead`, `MultipleSeat`, `Payment`, `Post`, `Promotion`, `Reporting`, `Score`, `Seat`, `Segment`, `Space`, `SubscriptionPlan`, `Unit`, `UnitAnalytics`, `Upcoming`, `UpdateUserProgress`, `User`, `UserGroup`, `UserProgress`, `UserRole`, `UserSubscription`.

...
The documentation for `@seneca/learnworlds-provider` follows the
...
definition held in the [SDK project](https://github.com/voxgig-sdk/learnworlds-sdk). An edit made here
